...
if __name__=="__main__":
    for data_type in ["linear_triangular", "linear_invertedtriangular", "concave_triangular", "concave_invertedtriangular", "convex_triangular", "convex_invertedtriangular"]:
      for reference_point in range(1,2):
   # Establish communication queues
        ...
        point_num = 10 #sol_num
        dimension = 3  #objective
        data_set_size = 100 #data_set
        #reference_point = 0
        data = read_data("../Data/data_set_{0}_{1}_{2}_{3}_{4}.mat".format(dimension, point_num, data_type, data_set_size, reference_point), "data_set")
        ...
        save_name = "../Result/HVC_{0}_{1}_{2}_{3}_{4}.mat".format(dimension, point_num, data_type, data_set_size, reference_point)
        save_dict = {'HVC': HVC}
